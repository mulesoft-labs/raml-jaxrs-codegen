...
import org.raml.jaxrs.codegen.core.visitors.TemplateResourceVisitor;

import com.sun.codemodel.JClass;
import com.sun.codemodel.JDefinedClass;

public class ExtendedVisitor extends TemplateResourceVisitor {
	...
	public void visit(ResourceEntity resourceEntity) {
		...
		JClass directClass = getCodeModel().directClass("org.raml.jaxrs.example.impl.LinkSupport");
